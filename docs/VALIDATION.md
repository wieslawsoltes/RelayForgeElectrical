...
The original calculator capture remains in the 0.2.0 source ZIP. Current desktop/mobile editor captures are in the `browser-evidence` artifact linked from [GitHub Pages validation](GITHUB-PAGES.md#verified-ci-evidence).
